...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'examia_db'),
        'USER': os.getenv('DB_USER', 'examia_user'),
        'PASSWORD': os.getenv('DB_PASSWORD', 'examia123'),
...
# También puedes permitir todos los orígenes en desarrollo
